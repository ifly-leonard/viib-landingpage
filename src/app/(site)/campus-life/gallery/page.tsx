...
export default function GalleryPage() {
  return (
    <>
      <CampusEditorialHero eyebrow="Campus gallery" title="Builder moments, documented." description="Workshops, conversations, milestones, experiments, and the people who bring the campus to life." image="/photos/early-campus/hackathon.png" />
