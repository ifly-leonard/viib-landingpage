...
import { GoldenHeroVariant } from "@/app/ui-guide/page-styles/[slug]/golden-hero";
...
export default function UiGuideComponentsPage() {
      ...
      <div className="min-h-screen bg-[color:var(--vil-ivory)] text-[color:var(--vil-navy)]">
        ...
        <main className="mx-auto max-w-6xl px-6 pb-24">
          ...
          <Section
            id="headers"
            title="Page headers"
            description="The hero patterns currently used across the site — photo hero, navy hero, cover hero, and the golden tint variant."
          >
            <div className="space-y-6">
              {/* Photo hero — Campus Visit */}
              <Block title="Photo hero — campus visit page">
                ...
                <div className="overflow-hidden rounded-3xl border border-[color:var(--border)]">
                  <section className="relative overflow-hidden bg-[color:var(--vil-navy)] pt-28 text-[color:var(--vil-ivory)] md:pt-36">
                    <div className="viiv-container relative z-10 pb-16 pt-8 md:pb-24">
                      ...
                      <p className="viiv-kicker text-[color:var(--vil-gold)]">Program</p>
                      <h1 className="mt-4 max-w-4xl font-display text-[clamp(2rem,5vw,3.75rem)] font-semibold leading-[1.05] tracking-[-0.04em] text-[color:var(--vil-ivory)]">
                        A venture college, not a lecture hall.
                      </h1>
                      <p className="mt-6 max-w-2xl text-lg leading-relaxed text-[color:var(--vil-ivory)]/80">
                        Three years of building real products with mentors, capital, and a cohort
                        beside you — full-time, offline, in Chennai.
                      </p>
                    </div>
                  </section>
                </div>
              ...
              {/* Cover hero — Library */}
              <Block title="Cover hero — library page">
                <div className="overflow-hidden rounded-3xl border border-[color:var(--border)]">
                  <LibraryPageHeader
                    eyebrow="Library"
                    title={
                      <h1 className="font-display text-[clamp(2rem,5vw,3.75rem)] font-semibold leading-[1.05] tracking-[-0.04em] text-[color:var(--vil-ivory)]">
                        Read. Build. Repeat.
                      </h1>
                    }
                    description="The reading list behind the VIIV method — builder guides, handbooks, and codes of conduct."
                  />
                </div>
              </Block>

              {/* Golden tint hero — variant */}
              <Block title="Golden tint hero — centered variant">
                <div className="overflow-hidden rounded-3xl border border-[color:var(--border)]">
                  <GoldenHeroVariant />
                </div>
              </Block>
