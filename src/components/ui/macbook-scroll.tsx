  ...
  return (
    ...
    >
      ...
      <div className="relative isolate">
        <div
          aria-hidden
          className="pointer-events-none absolute left-1/2 top-[42%] z-0 h-[32rem] w-[40rem] -translate-x-1/2 -translate-y-1/2 rounded-full blur-3xl"
          style={{
            background:
              "radial-gradient(ellipse at center, rgba(200,139,239,0.45) 0%, rgba(189,238,255,0.22) 40%, transparent 72%)",
          }}
        />
        <div
          aria-hidden
          className="pointer-events-none absolute left-1/2 top-[55%] z-0 h-[20rem] w-[28rem] -translate-x-1/2 -translate-y-1/2 rounded-full blur-2xl"
          style={{
            background:
              "radial-gradient(ellipse at center, rgba(142,167,255,0.28) 0%, transparent 68%)",
          }}
        />
        {/* Lid */}
        <Lid
