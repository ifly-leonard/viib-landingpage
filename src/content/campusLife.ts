...
export const campusRhythm = [
  { time: "Learn", title: "Start with the fundamentals", copy: "Understand the models, tools, and decisions behind business, product, sales, AI, finance, and leadership." },
  { time: "Build", title: "Move into studio mode", copy: "Turn the lesson into an interview, prototype, campaign, automation, operating document, or venture experiment." },
  { time: "Review", title: "Put the work in the room", copy: "Present to peers, mentors, founders, and operators. Explain the evidence and make the next decision visible." },
  { time: "Reflect", title: "Capture what changed", copy: "Document the result, the feedback, and the lesson before beginning the next cycle with a sharper question." },
] as const;
...
export const ventureStudioDetails = [
  { title: "AI & SaaS", copy: "Build software and AI-native services around validated customer problems. Explore recurring revenue, automation, product adoption, and scalable delivery.", icon: "01" },
  { title: "Healthcare", copy: "Investigate problems across access, care delivery, wellness, and health operations. Build responsibly around evidence, privacy, and stakeholder trust.", icon: "02" },
  { title: "Education", copy: "Design learning products, services, and systems for students, educators, and institutions. Test whether the solution improves access, engagement, or outcomes.", icon: "03" },
  { title: "D2C & Consumer Brands", copy: "Create a differentiated consumer proposition and bring it to market. Work across product, brand, sourcing, distribution, retention, and unit economics.", icon: "04" },
  { title: "Media & Creator Economy", copy: "Build ventures powered by audience, content, community, and intellectual property. Develop repeatable systems for attention, trust, and monetisation.", icon: "05" },
  { title: "FinTech", copy: "Explore products and services that improve how people and businesses manage money. Learn to balance user value, risk, compliance, and financial sustainability.", icon: "06" },
  { title: "Climate & Sustainability", copy: "Address resource, energy, waste, and resilience challenges with viable business models. Measure commercial value alongside environmental impact.", icon: "07" },
  { title: "DeepTech", copy: "Translate technical insight into a clear market opportunity. Focus on validation, defensibility, applications, partnerships, and the path from research to adoption.", icon: "08" },
  { title: "Manufacturing", copy: "Build around production, supply chains, quality, industrial services, and operational efficiency. Learn by understanding the system on the ground.", icon: "09" },
  { title: "Social Enterprise", copy: "Create sustainable models for meaningful social outcomes. Treat community insight, impact evidence, ethics, and financial resilience as core design inputs.", icon: "10" },
  { title: "Family Business Innovation", copy: "Develop new products, channels, systems, or growth engines within an existing enterprise. Preserve hard-earned strengths while testing the next opportunity.", icon: "11" },
] as const;
